    ...
    <section className={styles.section} id="about">
      <article className={styles.article}>
        ...
        <p className={styles.p}>
          ...
          leo, dapibus id sollicitudin ac, suscipit sed elit. Ut vulputate leo
          vel egestas volutpat. Pellentesque lacinia tristique ipsum, ut
          elementum tortor sodales ut.
        </p>
      </article>
